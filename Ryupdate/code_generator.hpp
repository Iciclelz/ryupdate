...
class function {
 public:
  ...
  function(access_specifier access,
...
class code_generator {
 public:
  ...
  code_generator(const std::string& class_name,
                 const implementation& constructor_impl = implementation(),
                 const implementation& destructor_impl = implementation());
  ~code_generator();
